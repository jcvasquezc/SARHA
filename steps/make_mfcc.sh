...
if [ -f $data/segments ]; then
  ...
  $cmd JOB=1:$nj $logdir/make_mfcc_${name}.JOB.log \
    ...
    compute-mfcc-feats --sample-frequency=48000 $vtln_opts --verbose=2 --config=$mfcc_config ark:- ark:- \| \
  ...
  $cmd JOB=1:$nj $logdir/make_mfcc_${name}.JOB.log \
    compute-mfcc-feats --sample-frequency=48000 $vtln_opts --verbose=2 --config=$mfcc_config \
